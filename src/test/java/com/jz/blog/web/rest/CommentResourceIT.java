...
import com.jz.blog.repository.CommentRepository;
...
class CommentResourceIT {
    ...
    public static Comment createEntity(EntityManager em) {
        Comment comment = new Comment().nickname(DEFAULT_NICKNAME).email(DEFAULT_EMAIL).content(DEFAULT_CONTENT);
        return comment;
    }
    ...
    public static Comment createUpdatedEntity(EntityManager em) {
        Comment comment = new Comment().nickname(UPDATED_NICKNAME).email(UPDATED_EMAIL).content(UPDATED_CONTENT);
        return comment;
    }
    ...
    void createComment() throws Exception {
        ...
        assertThat(testComment.getNickname()).isEqualTo(DEFAULT_NICKNAME);
    ...
    void putExistingComment() throws Exception {
        ...
        updatedComment.nickname(UPDATED_NICKNAME).email(UPDATED_EMAIL).content(UPDATED_CONTENT);
        ...
        Comment testComment = commentList.get(commentList.size() - 1);
        assertThat(testComment.getNickname()).isEqualTo(UPDATED_NICKNAME);
    ...
    void partialUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.nickname(UPDATED_NICKNAME).content(UPDATED_CONTENT);
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.nickname(UPDATED_NICKNAME).email(UPDATED_EMAIL).content(UPDATED_CONTENT);
