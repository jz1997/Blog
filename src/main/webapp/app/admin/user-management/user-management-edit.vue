          ...
          <div>
            ...
            <div class="form-group">
              ...
              <div v-if="$v.userAccount.login.$anyDirty && $v.userAccount.login.$invalid">
                <small class="form-text text-danger" v-if="!$v.userAccount.login.required"> This field is
                  required. </small>
            ...
            <div class="form-group">
              ...
              <div v-if="$v.userAccount.email.$anyDirty && $v.userAccount.email.$invalid">
                <small class="form-text text-danger" v-if="!$v.userAccount.email.required"> Your email is
                  required. </small>
