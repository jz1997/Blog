    ...
    <div class="row justify-content-center">
      <div class="col-8">
        <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
          <h2 id="blogApp.comment.home.createOrEditLabel" data-cy="CommentCreateUpdateHeading">Create or edit a
            Comment</h2>
          <div>
            ...
            <div class="form-group">
              ...
              <div v-if="$v.comment.nickname.$anyDirty && $v.comment.nickname.$invalid">
                <small class="form-text text-danger" v-if="!$v.comment.nickname.required"> This field is
                  required. </small>
            ...
            <div class="form-group">
              ...
              <div v-if="$v.comment.content.$anyDirty && $v.comment.content.$invalid">
                <small class="form-text text-danger" v-if="!$v.comment.content.required"> This field is
                  required. </small>
